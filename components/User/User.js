...
const User = ({ className, userToken }) => {
    ...
    return (
        <div className={className+` user`}>
            <img className="user__img" src="https://upload.wikimedia.org/wikipedia/commons/thumb/7/7e/Circle-icons-profile.svg/1024px-Circle-icons-profile.svg.png" alt="user" />
            <div className="user__text">
                <span className="user__text__name">{userInfo.display_name}</span>
